...
export default function RankSheet({ open, onOpenChange }: { open: boolean, onOpenChange: (open: boolean) => void }) {
    ...
    return (
        ...
        >
            <div
                ...
                className={cn(
                    "absolute bottom-0 left-0 w-full h-[90%] bg-[#f7f7f7] rounded-t-2xl flex flex-col p-0 transform transition-transform duration-300 ease-in-out",
                    open ? "translate-y-0" : "translate-y-full"
                )}
            >
                <div className="p-4 flex items-center justify-between flex-shrink-0 z-10 bg-white shadow-sm rounded-t-2xl">
